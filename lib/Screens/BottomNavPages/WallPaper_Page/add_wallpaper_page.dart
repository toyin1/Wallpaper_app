...
import 'package:wallpaper_app/Screens/BottomNavPages/WallPaper_Page/add_wallpaper_provider.dart';
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      //call pickImage here and since is async use .then()
                      pickImage().then((value) {
                        setState(() {
                          //create a string image above
                          image = value;
                        });
                      });
                    },
                  ...
                  // to show the preview of image selected
